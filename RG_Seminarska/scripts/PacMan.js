...
// funkcija za nalaganje sveta iz dolocene datoteke
// iz datoteke world.txt sparsa podatke in naredi svet
//
// handleLoadedWorld
//
...
function handleLoadedWorld(data) {
  ...
  for (var i in lines) {
    // shrani z vsakim linom eno steno
    ...
    if (vals.length == 5 && vals[0] != "//") {
      ...
      vertexTextureCoords.push(parseFloat(vals[4]));
       ...
       // gremo cez vsa vozlisca in vsakemu vozliscu pripisali teksturno koordinato
  ...
  // pobrisemo napis 'loading world'
  document.getElementById("loadingtext").textContent = "";
}


// naloudamo svet iz datoteke
//
// loadWorld
//
// Loading world 
...
function drawScene() {
  ...
  // na graficno kartico posljemo podatke za transformacijske metode
  // Draw the cube.
  setMatrixUniforms();
...
function animate() {
  ...
  if (lastTime != 0) {
    ...
    if (speed != 0) {
      ...
      // premikanje gor in dol kamere
      // za spreminjanje hitrosti je joggingAgnle
      joggingAngle += elapsed * 0.9; // 0.6 "fiddle factor" - makes it feel more realistic :-)
      // te parametri so costum, s poskusanjem so se dobili
...
function start() {
  ...
  if (gl) {
    ...
    gl.enable(gl.DEPTH_TEST);                               // omogocimo globinski test
    ...
    // zvezemo odzivne funkcije za tipkovnico
